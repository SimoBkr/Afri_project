...
import Tarif_FWL from './Tarif_FWL';
import Map from './MapViewFWL/Map';
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div style={{ marginLeft: "120px" }}>
                                    <img src="/img/Rail.png" className="image_rail" width="20px" />
                                </div>
                            </div>

                            <Popover content={<div>{shipment.cityFrom.name}</div>} title="Port Of" overlayStyle={{ width: "165px" }}>
                                <span className="color_land_rail_left checkbox-disabled">
                                </span>
                            </Popover>
                            <hr className="hr_rail_land" />

                            <div>
                                <Popover content={<div>{shipment.cityTo.name}</div>} title="Port Of" overlayStyle={{ width: "165px" }}>
                                    <span className="color_land_rail_right checkbox-disabled"></span>
                                </Popover>
                            </div>
                            <div>
                                            ...
                                            <div>
                                                ...
                                                <Collapse
                                                    ...
                                                    <div className="test5">
                                                        ...
                                                        <div>
                                                            {selecteD === 0 ? <Tarif_FWL shipment={shipment} /> : <Map  shipment={shipment} />}
                                                        </div>
                                                    </div>
                                                </Collapse>
                                            </div>
