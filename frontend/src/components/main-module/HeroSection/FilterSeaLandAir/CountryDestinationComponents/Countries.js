...
function Countries(props) {
    ...
    const { resultCountries, setformData, formData, loading, setdisplayComponentsDestination, displayComponentsDestination,
        searchPorts } = props;
                    ...
                    return (
                        <div
                            ...
                            onClick={() => {
                                ...
                                setformData({ ...formData, countryDestination: result.city });
                                searchPorts(result);
                            }}
                        >
